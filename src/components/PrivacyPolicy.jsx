    ...
    return (
      <React.Fragment>
        <div className={classes.contentContainer}>
          ...
          <br />
          <p className="para1"><h4>Collection of your Personal Information</h4>
          ...
          <p className="para1">Chune Supply may also use your personally identifiable information to inform you of other products or services 
            available from Chune Supply and its affiliates.</p><br/>
          <p className="para1">
          ...
          <p className="para1">Chune Supply may, from time to time, contact you on behalf of external business partners about a -First and 
            ...
            they are required to maintain the confidentiality of your information.</p><br/>
          <p className="para1">Chune Supply may disclose your personal information, without notice, if required to do so by law or in the good 
            ...
            personal safety of users of Chune Supply, or the public. </p><br/>
          <p className="para1">
          ...
          <p className="para1"><h4>Use of Cookies</h4>
          ...
          <p className="para1">You have the ability to accept or decline cookies. Most Web browsers automatically accept cookies, but you can usually 
            ...
            the interactive features of the Chune Supply services or websites you visit.</p><br/>
          <p className="para1">
            <h4>Links</h4>
          ...
          <p className="para1"><h4>E-mail Communications</h4>
          ...
          <p className="para1"><h4>External Data Storage Sites</h4>
          We may store your data on servers provided by third party hosting vendors with whom we have contracted.
          </p><br/>
          <p className="para1"><h4>Changes to this Statement</h4>
          ...
          <p className="para1"><h4>Contact Information</h4>
