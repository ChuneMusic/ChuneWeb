  ...
  render() {
    ...
    return (
      <StyledArticle.Article>
        <StyledArticle.ArticleImages images={`http://chune-prod.us-east-2.elasticbeanstalk.com/static/imgs/thumbs/medium/${article.image}` || 'https://placeholder.com/344x194'} />
